...
<nav class="navbar">
	<div class="navbar-content">
		...
		<ul class="navbar-list">
			...
			<li>
				<button name="New publication" on:click={() => changePathname("/new-publication")}>
					<svg color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24">
						{#if active === "/new-publication"}
			...
			<li>
				<button name="Notifications" on:click={() => changePathname("/notifications")}>
					<svg color="#262626" fill="#262626" height="24" role="img" viewBox="0 0 24 24" width="24"> <!-- viewBox="0 0 48 48" -->
